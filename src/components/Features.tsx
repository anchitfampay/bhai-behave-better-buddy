...
const Features = () => {
  ...
  return (
    <section id="features" className="py-32 relative overflow-hidden">
      {/* Background gradients inspired by Apple's aesthetic */}
      ...
      <div className="container px-4 md:px-6 relative z-10 mx-auto">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              <div className={`relative w-20 h-20 rounded-3xl ${feature.color} ${feature.borderColor} border backdrop-blur-sm flex items-center justify-center mb-8 transition-transform duration-500 group-hover:scale-110 shadow-lg shadow-blue-900/10`}>
