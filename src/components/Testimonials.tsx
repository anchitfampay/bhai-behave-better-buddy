...
const Testimonials = () => {
  ...
  return <section id="testimonials" className="relative bg-black py-0">
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => <div key={index} className="bg-gray-900/70 rounded-2xl p-6 shadow-xl border border-gray-800 relative group">
