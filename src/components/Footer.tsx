...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900/70 py-12">
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-amber-500">Bh.ai</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#how-it-works" className="text-gray-400 hover:text-amber-500 transition-colors">How It Works</a></li>
              <li><a href="#testimonials" className="text-gray-400 hover:text-amber-500 transition-colors">Testimonials</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <MessageCircle size={18} className="mr-2 text-amber-500" />
                <span className="text-gray-400">hello@bhai-app.com</span>
              </li>
              <li className="flex items-center">
                <Clock size={18} className="mr-2 text-amber-500" />
                <span className="text-gray-400">Support: Mon-Fri 9AM-6PM IST</span>
              </li>
            </ul>
          </div>
        </div>
